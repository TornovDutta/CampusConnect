      ...
      <div className="card p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 border-t border-slate-100 flex justify-end gap-3">
            ...
            <button type="submit" disabled={postJobMutation.isPending || (form.visibility === 'requested_college' && form.target_colleges.length === 0)} className="btn-primary px-8 flex items-center gap-2">
